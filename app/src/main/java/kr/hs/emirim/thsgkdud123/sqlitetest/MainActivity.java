package kr.hs.emirim.thsgkdud123.sqlitetest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butInput.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                db.execSQL("insert into idaltable values('"+editName.getText().toString()+"', "
    ...
    public class MyDBHelper extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("create table idaltable(gname char(40) primary key, gcount integer);");
        }
